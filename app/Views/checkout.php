        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="<?= base_url('checkout'); ?>">Checkout</a></li>
              ...
              <form action="#">
                   ...
                   <div class="form-group">
                        <label class="control-label">
                             ...
                             I agree with the <a href="<?= base_url('terms'); ?>" target="_blank">Terms &amp; Conditions</a>
                        </label>
                   </div>
