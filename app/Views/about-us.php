            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item active" href="<?= base_url('about-us'); ?>">About Us</a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              <h4>Vintage Vanguard</h4>
              <p>At Heavens, we're more than just thrift. We're treasure hunters, style-shapers, and sustainability champions. Dive into a world of unique finds, amazing deals, and feel-good vibes. Give pre-loved clothing a new life and discover your next statement piece, all while making a positive impact on the planet.</p>
